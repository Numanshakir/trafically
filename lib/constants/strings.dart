class Strings {
  ...
  // Splash Screen
  // slide one
  static const String slideOneTitle = "SAVE FUEL";
  static const String slideOneDesc =
      "Save fuel by avoiding unnecessary idling in traffic";
  static const String slideOneImage = "assets/splash_screen_1.jpg";

  // slide two
  static const String slideTwoTitle = "CARBON OFFSETTING";
  static const String slideTwoDesc =
      "Go carbon neutral by offsetting your CO2 emissions";
  static const String slideTwoImage = "assets/splash_screen_2.jpg";

  //slide three
  static const String slideThreeTitle = "AVOID TRAFFIC";
  static const String slideThreeDesc =
      "Plan ahead and avoid traffic bottlenecks";
  static const String slideThreeImage = "assets/splash_screen_3.jpg";

  // Main
  static const String calculatingRoute = "Calculating route";
}
